        ...
        <div class="container">
            <div class="contact-grid">
                ...
                <div class="contact-info" data-aos="fade-right">
                    <div class="info-card glass">
                        ...
                        <p class="section-desc">
                            <?php _e('Bạn có ý tưởng mới, một dự án hay ho hay đơn giản là muốn chia sẻ một hành trình? Đừng ngần ngại, trạm luôn mở cửa đón chờ!', 'laca'); ?>
                        </p>
                            ...
                            foreach ($socials as $key => $label):
                                ...
                                if ($url): ?>
                                    <a href="<?php echo esc_url($url); ?>" target="_blank" rel="nofollow"
                                        class="social-link"><?php echo esc_html($label); ?></a>
                                <?php endif;
                            endforeach; ?>
                        </div>
                    </div>
                ...
                <div class="contact-form-wrapper" data-aos="fade-left">
                    <form id="laca-contact-form" method="POST"
                        action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" class="glass"
                        data-sitekey="<?php echo esc_attr($site_key); ?>" novalidate>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="form-name"><?php _e('Họ và tên', 'laca'); ?> <span
                                        class="required">*</span></label>
                                <input type="text" id="form-name" name="name"
                                    placeholder="<?php _e('Họ và tên của bạn', 'laca'); ?>" required minlength="2"
                                    aria-required="true" aria-describedby="name-error">
                                <span class="error-message" id="name-error" role="alert"></span>
                            </div>
                            <div class="form-group">
                                <label for="form-phone"><?php _e('Số điện thoại', 'laca'); ?> <span
                                        class="required">*</span></label>
                                <input type="tel" id="form-phone" name="phone"
                                    placeholder="<?php _e('09xx xxx xxx', 'laca'); ?>" required aria-required="true"
                            ...
                            <div class="recaptcha-notice">
                                <small>
                                    ...
                                    <a href="https://policies.google.com/privacy" target="_blank"
                                        rel="noopener"><?php _e('Chính sách bảo mật', 'laca'); ?></a>
                                    <?php _e('và', 'laca'); ?>
                                    <a href="https://policies.google.com/terms" target="_blank"
                                        rel="noopener"><?php _e('Điều khoản dịch vụ', 'laca'); ?></a>
